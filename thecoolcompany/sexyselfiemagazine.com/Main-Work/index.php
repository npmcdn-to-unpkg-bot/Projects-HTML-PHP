        ...
        <div class="main-view">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="category" id="edit-submitted-country" required>
              <option value="">- Select -</option>
              <option value="1">$1 a pic for the inside submission</option>
          ...
          <div class="form-group">
            ...
            <input type="file" class="form-file" size="22" name="user_image[]" id="edit-submitted-upload-upload" required multiple="">
          </div>
          <div class="checkbox">
            <label>
